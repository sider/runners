  ...
  issues: [
    {
      ...
      "links": %w[https://github.com/rubocop-hq/rubocop/blob/v0.80.1/manual/cops_style.md#styledocumentation],
    ...
    },
    {
      ...
      "links": %w[
        ...
        https://github.com/rubocop-hq/rubocop/blob/v0.80.1/manual/cops_style.md#styleemptymethod
      ],
