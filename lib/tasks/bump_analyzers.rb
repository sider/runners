...
BumpAnayzers = Struct.new(
  ...
  def create_pull_request!
    call_github_api(:post, "/repos/sider/runners/pulls", {
  ...
  def pull_request_body
    <<~MARKDOWN
      See the [release](https://github.com/sider/runners/releases) for more details.
    MARKDOWN
  end
  ...
  def commit_and_push_changes!
    ...
    run! "git", "commit", "--all", "--message", <<~MSG
      #{pull_request_title}

      #{pull_request_body}
    MSG
    run! "git", "push", "--set-upstream", "origin", head_branch
  end
